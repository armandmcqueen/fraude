  ...
  return (
    <div className="flex items-start gap-2">
      <div className="flex-1 min-w-0">
        <p className="text-sm text-gray-600 dark:text-gray-300" title={image.prompt}>
          <span className="font-medium">Prompt:</span> {image.prompt}
        </p>
        {image.isSlideMode && image.slidePrompt && showSlidePrompt && (
          <p className="mt-2 text-sm text-blue-600 dark:text-blue-400" title={image.slidePrompt}>
            <span className="font-medium">Slide Prompt:</span> {image.slidePrompt}
          </p>
        )}
      </div>
      {image.isSlideMode && image.slidePrompt && (
        <button
          ...
          title={showSlidePrompt ? 'Hide slide prompt' : 'Show slide prompt'}
        >
